 ...
 * 
 */
public class AdsMonitorControllerNew {

	private static AdsMonitorControllerNew controller = new AdsMonitorControllerNew();
	...
	private AdsMonitorControllerNew() {
		if (monitors == null)
			monitors = new ArrayList<Thread>();
		// check existing tasks and run if needed
		resumeExistingTasks();
		this.monitorDao = new FileDao();
		logger = Logger.getInstance();
	}

	public static AdsMonitorControllerNew getInstance() {
		return controller;
	}
	...
	public void startMonitor(String name, String URL, String email,
		...
		try {
			...
			List<MonitoringJsonObject> curr_monitors = monitorDao
			...
			// from monitors
			monitorDao.getCurrentMonitorsFromFile();
		} catch (Exception e) {
			logger.close();
		}
	}
	...
	public void stopAllMonitors() {
		...
		try {
			List<MonitoringJsonObject> list = monitorDao
					.getCurrentMonitorsFromFile();
	...
	public static void main(String[] args) {
		AdsMonitorControllerNew controller = AdsMonitorControllerNew
				.getInstance();
